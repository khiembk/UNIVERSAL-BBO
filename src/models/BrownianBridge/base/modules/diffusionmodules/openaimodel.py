...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        self.fc_y = nn.Linear(y_dim, time_embed_dim)
    ...
    def forward(self, x, timesteps=None, y_high=None, y_low=None, context=None,**kwargs):
        """
        ...
        emb = emb + self.fc_y(th.cat([y_low,y_high],dim=1))
